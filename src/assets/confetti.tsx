...
import "./confetti.css"
type ConfettiProps = HTMLProps<SVGSVGElement>
export const Confetti: FC<ConfettiProps> = ({ style, ...rest }) => (
  <svg
    version="1.1"
    id="Layer_1"
    ...
    viewBox="0 0 400 400"
    style={{
      ["enableBackground" as keyof CSSStyleDeclaration]: "new 0 0 400 400",
      ...style,
    }}
    xmlSpace="preserve"
    {...rest}
